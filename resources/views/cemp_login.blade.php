			...
			<div role="main" class="main">
				...
				<div class="container py-2">
					...
					<div class="row">
                      ...
                      <h4 class="color-primary font-weight-semibold text-4 text-uppercase mb-3">Company Employer</h4>
                      <?php
                      ...
                      ?>
                      <form action="<?php echo base_url() ?>cemployer-login" id="frmSignIn" method="post" class="needs-validation">
                        <div class="form-row">
