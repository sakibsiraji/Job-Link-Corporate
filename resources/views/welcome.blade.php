...
<html lang="en-US">
	<head>
		...
		<meta name="google-site-verification" content="RAQTkMyJx7on2zIf6zm1kHcXgm-EHZuIBWMR8Jk97mY" />
					...
					<div id="revolutionSlider" class="slider rev_slider" data-version="5.4.8" data-plugin-revolution-slider data-plugin-options="{'sliderLayout': 'fullscreen', 'delay': 9000, 'gridwidth': 1170, 'gridheight': 700, 'disableProgressBar': 'on', 'responsiveLevels': [4096,1200,992,500], 'parallax': { 'type': 'scroll', 'origo': 'enterpoint', 'speed': 1000, 'levels': [2,3,4,5,6,7,8,9,12,50], 'disable_onmobile': 'on' }}">
						<ul>
							<li class="slide-overlay" data-transition="fade">
								<img src="{{asset('assets/img/slides/slide-home-1.jpg')}}"
									alt=""
								...
								<div class="tp-caption"
									...
									data-transform_idle="opacity:0.2;s:500;"><img src="{{asset('assets/img/slides/slide-title-border.png')}}" alt=""></div>
								...
								<div class="tp-caption text-color-light font-weight-normal"
									...
									data-transform_in="y:[-50%];opacity:0;s:500;">YOU WISH AND WE MAKE IT COME TRUE</div>
								...
								<h1 class="tp-caption font-weight-extra-bold text-color-light negative-ls-2"
									...
									data-lineheight="['55','55','55','95']">LOOKING FOR A JOB?</h1>
								...
								<div class="tp-caption font-weight-light text-center"
									...
									style="color: #b5b5b5;">JLC is a huge success in one of the world’s largest MarketPlace.</div>
								...
								<a class="tp-caption btn btn-primary font-weight-bold"
									...
									data-paddingright="['33','33','33','50']"
									data-fontsize="['13','13','13','25']"
									data-lineheight="['20','20','20','25']">REGISTER NOW <i class="fas fa-arrow-right ml-1"></i></a>

							</li>
							<li class="slide-overlay" data-transition="fade">
								<img src="{{asset('assets/img/slides/slide-home-2.jpg')}}"
									alt=""
									data-bgposition="center center"
									data-bgfit="cover"
									data-bgrepeat="no-repeat"
								...
								<div class="tp-caption font-weight-extra-bold text-color-light negative-ls-2"
									...
									data-y="center" data-voffset="['-60','-60','-60','-85']"
									data-fontsize="['50','50','50','90']"
									data-lineheight="['55','55','55','95']">JOB LINK CORPORATE</div>
								...
								<div class="tp-caption font-weight-light text-center"
									...
									data-fontsize="['18','18','18','50']"
									data-lineheight="['29','29','29','40']"
									style="color: #b5b5b5;">LOOKING TO HIRE?</div>
								...
								<a class="tp-caption btn btn-primary font-weight-bold"
									...
									data-paddingright="['33','33','33','50']"
									data-fontsize="['13','13','13','25']"
									data-lineheight="['20','20','20','25']">REGISTER AS AN EMPLOYER <i class="fas fa-arrow-right ml-1"></i></a>
				...
				<div class="container container-lg py-5 my-5">
					<div class="row justify-content-center">
						<div class="col-xl-9 text-center">
							<h2 class="font-weight-bold text-11 appear-animation" data-appear-animation="fadeInUpShorter">We are JLC, we are Awesome</h2>
							<p class="line-height-9 text-4 opacity-9 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">We are dedicated to find the best opportunities for the candidates with the best offerings. We are also concerned about the companies hiring candidates. That's why we ensure the best quality of candidates from all over the world. Apart from these, we establish reliable B2B connections between companies for their various business needs. We always follow four steps to avoid any kind of unwanted situatuation while doing business.</p>
						</div>
					</div>
						...
						<div class="col-sm-6 col-lg-3 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="400">
							<div class="featured-box mb-lg-0">
								<div class="box-content px-lg-1 px-xl-5">
									...
									<p>We always work strategically. Whenever you assign us to do something for you, at first, we decide our strategy.</p>
								</div>
							</div>
						</div>
						<div class="col-sm-6 col-lg-3 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="200">
							<div class="featured-box mb-lg-0">
								<div class="box-content px-lg-1 px-xl-5">
									...
									<p>Then we focus on our work plan as per our strategy. We also plan the possible obstacles and how to face them without hampering work.</p>
								</div>
							</div>
						</div>
						<div class="col-sm-6 col-lg-3 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="200">
							<div class="featured-box mb-sm-0">
								<div class="box-content px-lg-1 px-xl-5">
									...
									<p>After being ready with the strategy and work plan, we start to work. Our team is hard working enough to make us proud and make our clients satisfied as well.</p>
								</div>
							</div>
						</div>
						<div class="col-sm-6 col-lg-3 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="400">
							<div class="featured-box mb-0">
								<div class="box-content px-lg-1 px-xl-5">
									...
									<p>After working hard on our great work plan, our team delivers the best quality service.</p>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="container">
						<div class="row align-items-center justify-content-center justify-content-lg-between pb-5 pb-lg-0">
							<div class="col-lg-5 order-2 order-lg-1 pt-4 pt-lg-0 pb-5 pb-lg-0 mt-5 mt-lg-0 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="200">
								...
								<p class="lead font-weight-light text-color-light text-4">At JLC, we aim to establish a worldwide employment hub for employers and job seekers. We categorize our employers into-</p>
								<p class="font-weight-light text-color-light text-2 mb-4 opacity-7">1.	Company Employer:  You need a lawyer for your latest contract signing? You got one!<br>
								2.	Individual Employer: Need a mechanic for your car? Just click and they’re on their way!<br>
								3.	B2B: We also establish Business to business connection for any business outsourcing!</p>
								<a href="services" class="btn btn-dark-scale-2 btn-px-5 btn-py-2 text-2">LEARN MORE</a>
							</div>
							<div class="col-9 offset-lg-1 col-lg-5 order-1 order-lg-2 scale-2">
								<img class="img-fluid box-shadow-3 my-2 border-radius" src="{{asset('assets/img/gallery/1.png')}}" alt="" width="220">
							</div>
						</div>
					</div><br>
				</section>
				...
				<div class="home-intro mb-0" id="home-intro">
					<div class="container">
						...
						<div class="row text-center">
							<div class="col">
								<p class="mb-0">
									Our <span class="highlighted-word text-color-light font-weight-semibold text-5">Respected</span> Clients
								</p>
							</div>
						</div>
