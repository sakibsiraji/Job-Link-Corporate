		...
		<div class="body">
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12 align-self-center p-static order-2 text-center">
								<h1>Special Skilled Employee Registration</h1>
							</div>
						</div>
					</div>
				</section>
		  ...
		  @endif
					  ...
					  {{@csrf_field()}}
                        ...
                        <div class="form-row">
                          <div class="form-group col">
                            <label for='seskill_id' class="font-weight-bold text-dark text-2">Your Skill</label>
                            <select class="form-control form-control-lg" name="seskill_id" >
                              <option value="1">Pion</option>
                              <option value="2">Cleaner</option>
                              <option value="3">Gardener</option>
                              <option value="4">Garment Technician/Machine Operator</option>
                              <option value="5">Carpenter</option>
                              <option value="6">Show-room Assistance/Salesman</option>
                              <option value="7">Data Entry/Computer Operator</option>
                              <option value="8">Mechanic/Technician</option>
                              <option value="9">Nurse</option>
                              <option value="10">Waiter/Waitress</option>
                              <option value="11">Pathologist/Lab Assistant</option>
                              <option value="12">Electrician/Electronic Technician</option>
                              <option value="13">Driver</option>
                              <option value="14">Chef/Cook</option>
                              <option value="15">Housekeeper</option>
                              <option value="16">Security Guard</option>
                              <option value="17">Graphic Designer</option>
                              <option value="18">Welder</option>
                              <option value="19">Plumber/Pipefitting</option>
                              <option value="20">Sewing Machine Operator</option>
                              <option value="21">Masonry/Construction Worker</option>
                              <option value="22">CAD Operator</option>
                              <option value="23">Delivery Man</option>
                              <option value="24">Other Special Skilled Jobs</option>
                            </select>
                          </div>
                        </div>
                        <div class="form-row">
